...
@section('code', '503')
@section('message', 'Sistem Sedang Diperbarui')
@section('description', 'Smart UMKM Bali saat ini sedang menjalani proses pemeliharaan dan pembaruan rutin untuk meningkatkan pengalaman Anda. Silakan kembali beberapa saat lagi.')
