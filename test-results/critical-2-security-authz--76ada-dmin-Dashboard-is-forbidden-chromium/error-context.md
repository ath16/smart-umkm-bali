...
- Name: critical/2-security-authz.spec.ts >> Security & Authorization Flow >> Customer to Admin Dashboard is forbidden
- Location: tests/e2e/critical/2-security-authz.spec.ts:45:3
